...
function doGet(_e) {
  ...
  const wcRowFourIndexToRoomNameMap = new Map([
    [0, 'Room 1'],
    [1, 'Room 2'],
    [2, 'Room 3'],
    [3, 'Room 4'],
  ...
  allRooms.DT = extractRooms('DT', 'C4:I4', dtRowFourIndexToRoomNameMap);
  allRooms.WC = extractRooms('WC', 'C4:G4', wcRowFourIndexToRoomNameMap);
