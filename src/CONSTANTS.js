...
const ENABLE_NDA_ATTACHMENT_DOWNLOADS = false;
...
function IS_CH_EXTRA_APPT_COLUMN(typeCategory, resourceId) {
    return typeCategory === CH_AND_WC_SCHEDULED_APPT_CATEGORY
        && resourceId === CH_DVM_3_APPTS_RESOURCE_ID;
}
